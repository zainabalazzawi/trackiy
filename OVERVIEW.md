...
How the app is built and how the pieces fit together. For local setup, see [README.md](./README.md).
...
3. **Work on a Kanban board** — drag tickets across columns; default flow is *Ready to Development → In Development → Code Review → QA → Done*.
