...
export default function LandingPage() {
  ...
  return (
    <div className="flex items-center justify-center p-4 sm:p-8 bg-gradient-to-br from-slate-100 via-white via-50% to-[#649C9E]/5">
      <Card className="max-w-5xl shadow-2xl border border-slate-200/50 backdrop-blur-sm">
        <CardContent className="p-8 sm:p-12 lg:p-16 text-center space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto pt-6">
            <div className="flex flex-col items-center gap-1 p-6 rounded-2xl bg-gradient-to-br from-white to-slate-50/50 shadow-lg hover:shadow-2xl hover:shadow-primary transition-all duration-300 border border-slate-200/60 hover:border-[#649C9E]/50 hover:-translate-y-1">
              <div className="p-4 rounded-full bg-gradient-to-br from-[#649C9E] to-[#527f81] shadow-lg shadow-[#649C9E]/30">
          ...
          <div className="space-y-6 max-w-md mx-auto pt-6">
            {session ? (
              <>
                <div className="p-4 rounded-xl bg-gradient-to-r from-[#649C9E]/15 to-[#527f81]/10 border border-[#649C9E]/30 shadow-sm">
                ...
                <Button
                  size="lg"
                  className="w-full bg-gradient-to-r from-[#649C9E] to-[#527f81] hover:from-[#527f81] hover:to-[#3d6061] text-white shadow-lg hover:shadow-2xl hover:shadow-primary-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-0.5 text-base font-semibold py-6"
