...
export default function ProjectPage({
  ...
  return (
    <div className="p-3 sm:p-6 bg-gradient-to-br from-slate-50 to-white min-h-screen">
      <div className="mb-4 sm:mb-6 max-w-full flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 bg-gradient-to-br from-white via-slate-50/30 to-white p-3 rounded-xl border border-slate-200/80 backdrop-blur-sm">
        <div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button
                variant="outline"
                className="rounded-full p-3 sm:p-4 border-[#649C9E] hover:bg-gradient-to-r hover:from-[#649C9E] hover:to-[#527f81] hover:text-white transition-all duration-300"
                size="icon"
              >
                <UserPlus className="w-4 h-4 sm:w-5 sm:h-5" />
              </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-md border-slate-200/80 bg-gradient-to-br from-white to-slate-50/30">
              <DialogHeader>
